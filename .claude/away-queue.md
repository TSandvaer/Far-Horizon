   ...
   **Full 9-step checklist is posted on the PR:** https://github.com/TSandvaer/Far-Horizon/pull/351#issuecomment-5137194461
   ...
   - 🔴 **THE SOAK QUESTION HAS CHANGED — bar #10 is NOT met, and the hand-off wrongly claimed it was.** Correction posted: https://github.com/TSandvaer/Far-Horizon/pull/351#issuecomment-5137465736
     ...
     - **Your decision is therefore a design call, not an eye test:**
       **(a)** add a **FORM** channel — Uma's proposal and the cheap one: the **white edge-highlight plane** already documented in `blender-asset-pipeline.md` §3 (line 94). Geometry FORM, on-material, **zero material fork**, so it does not break the one-material invariant that killed the rim. `lowpoly-quality.md` Rec 5 agrees. **or (b)** waive bar #10 for this cue as a deliberate, recorded exception.
