...
namespace FarHorizon
{
    ...
    public class SettingsPanel : MonoBehaviour
    {
        ...
        [Tooltip("The chop swing driver (86caa4c5c) — tool-use speed flips the reserved row live to its " +
                 "swingSpeed. May be null; the tool-use-speed row then stays greyed (extension hook).")]
        public ChopPoseDriver chopDriver;
        ...
        void Awake()
        {
            ...
            if (chopDriver == null) chopDriver = FindObjectOfType<ChopPoseDriver>();
        ...
        void Start()
        {
            ...
            Registry = SettingsCatalog.Build(orbit, wasd, thirst, chopDriver, chopTree);
